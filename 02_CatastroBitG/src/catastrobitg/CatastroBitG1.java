...
public class CatastroBitG1 {
    ...
    public CatastroBitG1(int cant){
        this.max = cant;
        v1 = new VectorGenBit(max,23);
        v2 = new VectorGenBit(max,12);
        nombre = new String[max];
    } 
    
    public void insert(int num, String nombres, int uv, int mz, int lote, int h2o, int luz, int pav, int alcan, int tele, int supcie, int zona) {
